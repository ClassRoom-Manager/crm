...
<div class="card shadow mb-4">
    <!-- Search -->
    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" style="padding: 10px 10px; margin-bottom: 15px; padding-top: 20px; width: 70%;">
        <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="Buscar salón" aria-label="Search" aria-describedby="basic-addon2">
    ...
    <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="text-center">
                                <input type="radio" aria-label="Radio button for following text input" id="opcion2" name="seleccion">
                            </div>
                        </td>
                        <td>502</td>
                        <td>15</td>
                    ...
                    <tr>
                        <td>
                            <div class="text-center">
                                <input type="radio" aria-label="Radio button for following text input" id="opcion3" name="seleccion">
                            </div>
                        </td>
                        <td>502</td>
                        <td>15</td>
                    ...
                    <tr>
                        <td>
                            <div class="text-center">
                                <input type="radio" aria-label="Radio button for following text input" id="opcion4" name="seleccion">
                            </div>
                        </td>
                        <td>502</td>
                        <td>15</td>
        ...
        <div class="text-center mb-4">
            <a href="#" class="btn btn-primary btn-md shadow btn-opaco" id="btnEditar" onclick="verificarSeleccion()">
                <i class="fas fa-edit fa-lg text-white-30"></i> Editar
            </a>

            <a href="#" class="btn btn-success btn-md shadow ml-2" id="btnGuardar" disabled><i class="fas fa-save fa-lg text-white-40"></i>
                Guardar</a>
        </div>
...
<div class="modal fade" id="modalEditSalon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
